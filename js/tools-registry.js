...
const TOOL_ICONS = {
  ...
  'everdur-alloy': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l8 4v6c0 4-3.5 7.5-8 9-4.5-1.5-8-5-8-9V6l8-4z"/><path d="M9 12h6m-3-3v6"/></svg>`,
...
const TOOLS = [
  // ── DIGITAL TOOLS ─────────────────────────────────────────────────────────
  {
    id: 'image-resizer',
    label: 'Image Resizer',
    description: 'Resize images to WebP in the browser. Set a longest-edge target and quality, then download a ZIP. No upload required.',
    category: CATEGORIES.DIGITAL,
    path: 'tools/image-resizer.html',
    tags: ['image', 'resize', 'webp', 'convert', 'compress', 'batch', 'photo', 'jpg', 'png'],
    featured: false,
  },
  ...
  {
    id: 'everdur-alloy',
    label: 'Everdur Alloy Calculator',
    description: 'Calculate silicon and manganese additions for a target Everdur composition. Enter your copper charge weight — get exact amounts for CDA 873, C65500, or a custom ratio.',
    category: CATEGORIES.FOUNDRY,
    path: 'tools/everdur-alloy.html',
    tags: ['everdur', 'silicon bronze', 'alloy', 'copper', 'silicon', 'manganese', 'casting', 'foundry'],
    featured: false,
  },
